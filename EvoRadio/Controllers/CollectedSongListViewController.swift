//
//  CollectedSongListViewController.swift
//  EvoRadio
//
...
extension CollectedSongListViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    @objc func clearButtonPressed(_ button: UIButton) {
        ...
        NotificationCenter.default.post(name: .updateCollectedSongsCount, object: nil)
    }
