...
class MZUtility: NSObject {
    ...
    public class func getUniqueFileNameWithPath(_ filePath : NSString) -> NSString {
    ...
    public class func calculateFileSizeInUnit(_ contentLength : Int64) -> Float {
    ...
    public class func calculateUnit(_ contentLength : Int64) -> NSString {
    ...
    public class func calculateUnit2(_ contentLength : Int64) -> NSString {
        if(contentLength >= (1024*1024*1024)) {
            return "G"
        } else if contentLength >= (1024*1024) {
            return "M"
    ...
    public class func addSkipBackupAttributeToItemAtURL(_ docDirectoryPath : NSString) -> Bool {
